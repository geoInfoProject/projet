...
import com.GestionDossiers.demande_autorisation.repository.DocumentRepository;
...
public class DemandeController {
    ...
    public ResponseEntity<String> createDemande(
        ...
        for (MultipartFile file : files) {
            ...
            document.setDemande(savedDemande); // Associer le document à la demande
            documents.add(document);
        }

        // Sauvegarder tous les documents dans la base de données
        documentRepository.saveAll(documents);

        // Mettre à jour la demande avec la liste de documents sauvegardés
